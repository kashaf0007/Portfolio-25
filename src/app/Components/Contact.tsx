  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-col text-center w-full mb-12">
      ...
      <p className="lg:w-2/3 mx-auto leading-relaxed text-xl text-cyan-600 ">
        Lets build something greate together.Reach out via form the below!
      </p>
    </div>
    <div className="lg:w-1/2 md:w-2/3 mx-auto">
      <div className="flex flex-wrap -m-2">
        ...
        <div className="p-2 w-full">
          <button className="lg:mt-2 xl:mt-0 flex-shrink-0 inline-flex rounded-xl bg-gray-100 text-black border-1 border-blue-600 py-2 px-6 focus:outline-none hover:bg-cyan-500/50 hover:text-white ml-80 font-bold">
            Contact Me
          </button>
         
        </div>
        <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
          <a className="text-white">nasreenan47@gmail.com</a>
          ...
          target="_blank"
          className="text-white text-3xl px-2 hover:text-cyan-500 transition"> 
          <FaFacebook />
          </Link>
